            ...
            <div className="card login-container">
                ...
                <div>
                    <nav className="nav nav-pills nav-fill">
                        <a onClick={this.showLogin} id="login_nav" className="nav-item nav-link active" >Login</a>
                        <a onClick={this.showRegister} id="register_nav" className="nav-item nav-link" >Register</a>
                    </nav>
                </div>
                {/* Form Container */}
                <div>
